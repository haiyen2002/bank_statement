    ...
    return (
        <section className="flex flex-col pt-5 pl-[33px] pr-[33px] pb-6 h-full h-[1119px] mx-auto  w-[794px]" >
            <div className="flex mb-2" style={{ lineHeight: "15px" }}>
                ...
                <div className="flex" style={{ width: 110, justifyContent: "end" }}><b>98.643.106</b></div>
                <div className="flex" style={{ width: 110, justifyContent: "end" }}><b>263.348.402</b></div>
            </div>
            <div className="flex mb-2" style={{ lineHeight: "15px" }}>
                <div style={{ width: 380 }}>
                    <b>
                ...
                <div className="flex" style={{ width: 110, justifyContent: "end" }}><b>168,256,843</b></div>
            </div>
                ...
                <div style={{ textAlign: "center", justifyContent: "center", alignItems: "center", display: "flex", flexDirection: "column" }}>
                    ...
                    <p>
                        <b>
                            ...
                            <div style={{border:"1.2px solid", width:"190px",borderBottomStyle:"hidden" }}></div>
                            </div>
...
//     return (
//         <section className="flex flex-col pt-5 pl-[24px] pr-[24px] pb-6 h-full h-[1121px] mx-auto  w-[794px]" >
//             <div className="flex mb-2" style={{ lineHeight: "15px" }}>
//                 <div style={{ width: 160 }}>
//                     <b>
//                         <p> Tổng số:</p>
...
//                     </b>
//                 </div>
//                 <div className="flex" style={{ width: 110, justifyContent: "end" }}><b>393,238,465</b></div>
//                 <div className="flex" style={{ width: 110, justifyContent: "end" }}><b>424,718,145</b></div>
//             </div>
//             <div className="flex mb-2" style={{ lineHeight: "15px" }}>
//                 <div style={{ width: 380 }}>
//                     <b>
...
//                     </b>
//                 </div>
//                 <div className="flex" style={{ width: 110, justifyContent: "end" }}><b>48,579,561</b></div>
//             </div>
//             <div className="flex mb-[150px]" style={{ justifyContent: "end" }}>
//                 <div>
//                     <p><b>Xác nhận của ngân hàng</b></p>
