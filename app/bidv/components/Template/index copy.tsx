...
//     <section
//       style={bodyStyle}
//       className="flex flex-col pt-[70px] pl-[30px] pr-[30px] pb-6 h-full h-[1180px] mx-auto  w-[860px]" >
//       {header ? (<header>
//         {/* Header top */}
...
//                 <span className="mr-2"><b>Chi nhánh/Branch:</b></span>
//                 <span><b>NHTMCP DT&PTVN-CN DONG DONG NAI</b></span>
//               </div>
//               <div className="flex justify-center mt-[8px]">
//                 <div className="w-[140px]" style={{ border: "1px solid" ,borderBottomStyle:"hidden"}}></div>
//               </div>
...
//             <div className="flex"><div className="w-[150px]">Ngày in/Prt Date:</div> <span>  03/05/2024 10:31:06</span></div>
//           </div>
//         </div>
...
//               <div className="mt-3">
//                 <div>
//                   <span className="mr-4"><b >Từ ngày<span style={{ fontSize: "10px" }}>/</span></b>From Date:</span> <span className="mr-5">01/04/2023</span>
//                   <span className="mr-4"> <b>Đến ngày<span style={{ fontSize: "10px" }}>/</span></b>To date:</span> <span>25/04/2024</span>
//                 </div>
//               </div>
//             </div>
...
//                     <i>Address:</i>
//                   </div>
//                   <div className="w-[210px]">804/1, KP TRUONG KHANH, LONG PHUOC, QUAN 9 /,TP HO CHI MINH</div>
//                 </div>
...
//             </th>
//             <th style={{ width: "45px" }}>
//               <div className="h-[35px]  w-[45px] flex justify-between" style={{ flexDirection: "column" }}>
...
//                   </td>
//                   <td   className="w-[44px]" style={{ textAlign: "left", verticalAlign: "middle" }} >
//                     <div className="w-[44px]" style={{wordBreak:"break-word"}}>
//                     {item.c}
//                     </div>
//                   </td>
...
//                   <b>1,775,182,760.00</b>
//                 </td>
//                 <td style={{ textAlign: "right", verticalAlign: "middle" }}>
//                   <b>1,530,343,260.00</b>
//                 </td>
//                 <td colSpan={5}></td>
//               </tr>
//               <tr className={style.row_first} style={{ height: "35px" }}>
...
//           </tbody>
//         </table>
//         {footer && <div className="mt-2"><b className="ml-[430px]">Người tạo:</b> <span className="ml-6">151540</span></div>}
//       </div>
...
//       <footer className="mt-auto mb-[40px] text-[11px] text-center leading-[1.15] tracking-[-0.3px]">
//         {footer && <div  className="flex w-[351px] ml-[351px]" style={{flexDirection:"column",fontSize:"14px"}}>
...
//           <div style={{textAlign:"left"}}>Đông Đồng Nai</div>
//           <div style={{textAlign:"left"}}>Thời gian ký: 03/05/2024 10:31:06</div>
//         </div>}
